...
int32 UAuraDamageGameplayAbility::GetRoundedDamageAtLevel(int32 Level, const FGameplayTag& DamageTypeTag) const
{
	checkf(DamageType.MatchesTag(DamageTypeTag), TEXT("GameplayAbility %s is not DamageType %s"),
